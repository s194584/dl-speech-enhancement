...
### useage ###
# (run w/ gpu): python demoStream.py --tx_cuda 1 --rx_cuda 2 --model libritts_v1 --input_device x --output_device o
# (run w/ cpu): python demoStream.py --tx_cuda -1 --rx_cuda -1 --model libritts_sym --input_device x --output_device o
...
def main():
    ...
    audiodec.load_transmitter(model_path)
    audiodec.load_receiver(model_path, model_path)
